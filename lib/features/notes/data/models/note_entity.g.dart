...
const NoteEntitySchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {
    r'NoteBlockEntity': NoteBlockEntitySchema,
    r'ChecklistItemEntity': ChecklistItemEntitySchema
  },
...
int _noteEntityEstimateSize(
  ...
  {
    final offsets = allOffsets[NoteBlockEntity]!;
    for (var i = 0; i < object.blocks.length; i++) {
      final value = object.blocks[i];
      bytesCount +=
          NoteBlockEntitySchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _noteEntitySerialize(
  ...
  writer.writeObjectList<NoteBlockEntity>(
    offsets[0],
    allOffsets,
    NoteBlockEntitySchema.serialize,
    object.blocks,
  );
...
NoteEntity _noteEntityDeserialize(
  ...
  object.blocks = reader.readObjectList<NoteBlockEntity>(
        offsets[0],
        NoteBlockEntitySchema.deserialize,
        allOffsets,
        NoteBlockEntity(),
      ) ??
      [];
...
P _noteEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<NoteBlockEntity>(
            offset,
            NoteBlockEntitySchema.deserialize,
            allOffsets,
            NoteBlockEntity(),
...
extension NoteEntityQueryFilter
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> blocksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'blocks',
        0,
...
extension NoteEntityQueryObject
    on QueryBuilder<NoteEntity, NoteEntity, QFilterCondition> {
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> blocksElement(
      FilterQuery<NoteBlockEntity> q) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQueryProperty
  ...
  QueryBuilder<NoteEntity, List<NoteBlockEntity>, QQueryOperations>
      blocksProperty() {
    return QueryBuilder.apply(this, (query) {
...
const NoteBlockEntitySchema = Schema(
  name: r'NoteBlockEntity',
  id: -4047233653741288443,
  properties: {
    r'items': PropertySchema(
      id: 0,
      name: r'items',
      type: IsarType.objectList,
      target: r'ChecklistItemEntity',
    ),
  ...
  estimateSize: _noteBlockEntityEstimateSize,
  serialize: _noteBlockEntitySerialize,
  deserialize: _noteBlockEntityDeserialize,
  deserializeProp: _noteBlockEntityDeserializeProp,
);

int _noteBlockEntityEstimateSize(
  NoteBlockEntity object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  {
    ...
    if (list != null) {
      ...
      {
        final offsets = allOffsets[ChecklistItemEntity]!;
        for (var i = 0; i < list.length; i++) {
          final value = list[i];
          bytesCount += ChecklistItemEntitySchema.estimateSize(
...
void _noteBlockEntitySerialize(
  NoteBlockEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  writer.writeObjectList<ChecklistItemEntity>(
    offsets[0],
    allOffsets,
    ChecklistItemEntitySchema.serialize,
    object.items,
  );
...
NoteBlockEntity _noteBlockEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = NoteBlockEntity();
  object.items = reader.readObjectList<ChecklistItemEntity>(
    offsets[0],
    ChecklistItemEntitySchema.deserialize,
    allOffsets,
    ChecklistItemEntity(),
  );
...
P _noteBlockEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<ChecklistItemEntity>(
        offset,
        ChecklistItemEntitySchema.deserialize,
        allOffsets,
        ChecklistItemEntity(),
...
extension NoteBlockEntityQueryFilter
    on QueryBuilder<NoteBlockEntity, NoteBlockEntity, QFilterCondition> {
  QueryBuilder<NoteBlockEntity, NoteBlockEntity, QAfterFilterCondition>
      itemsIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteBlockEntityQueryObject
    on QueryBuilder<NoteBlockEntity, NoteBlockEntity, QFilterCondition> {
  QueryBuilder<NoteBlockEntity, NoteBlockEntity, QAfterFilterCondition>
      itemsElement(FilterQuery<ChecklistItemEntity> q) {
    return QueryBuilder.apply(this, (query) {
...
const ChecklistItemEntitySchema = Schema(
